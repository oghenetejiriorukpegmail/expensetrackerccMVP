          ...
          <div class="md:col-span-2">
            ...
            <div class="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-6 text-center">
              <div v-if="form.receipt_url || receiptPreview" class="mb-4">
                ...
                />
                <!-- PDF preview -->
                <div v-else class="rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
                  <!-- PDF viewer -->
                  <object
                    :data="receiptPreview || form.receipt_url"
                    type="application/pdf"
                    class="w-full h-48 rounded-lg"
                  >
                    <div class="h-48 flex flex-col items-center justify-center bg-gray-100 dark:bg-gray-800">
                  ...
                  <!-- Open PDF button -->
                  <div class="px-3 py-2 bg-gray-50 dark:bg-gray-700 text-center">
                    <a 
                      :href="receiptPreview || form.receipt_url" 
                      target="_blank" 
                      class="text-xs text-primary-600 dark:text-primary-400 hover:underline inline-flex items-center"
                    >
